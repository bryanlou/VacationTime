    ...
    <section className="py-12 md:flex md:justify-between">
      <div className="lg:w-1/2">
        ...
        <div className="flex justify-center md:justify-start mt-10">
          <button
            className="inline-flex items-center px-6 py-3 rounded-lg shadow bg-black hover:bg-black hover:shadow-lg focus:outline-none focus:bg-black text-white font-small tracking-wide"
            onClick={queryPlaces}>
            Submit
          </button>
